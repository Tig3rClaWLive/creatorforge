...
async function currentUser(req, env) {
  ...
  return await env.DB.prepare(
    "SELECT users.id,email,role,created_at FROM sessions JOIN users ON users.id=sessions.user_id WHERE sessions.id=? AND sessions.expires_at>?"
