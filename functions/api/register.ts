...
export const onRequestPost = async ({request,env})=>{
  ...
  await env.DB.prepare('INSERT INTO creator_profiles (id,user_id,display_name,bio,twitch,tiktok,youtube,kick,discord,donation_url,created_at,updated_at) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)')
